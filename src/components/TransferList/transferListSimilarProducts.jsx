        ...
        <main className='transferlist-container'>
            ...
            <div className='fields-section'>
                ...
                <section className='transfer-list'>
                    ...
                    >
                    <Grid sx={{ width: '40%' }} >{customList('Não Similares', nonSimilarProducts)}</Grid>
                    <Grid>
                        ...
                        <Button
                            ...
                            disabled={
                                checked.filter((c) => nonSimilarProducts.some((v) => v.id === c.id)).length === 0
                                }
                        ...
                        <Button
                            ...
                            disabled={
                                checked.filter((c) => similarProducts.some((v) => v.id === c.id)).length === 0
                                }
                    ...
                    <Grid sx={{ width: '40%' }}>{customList('Similares', similarProducts)}</Grid>
                    </Grid>
